%% Función que invierte un vector; ejemplo
...
function y = invVector( x ) 
    ...
    for i = 1 : tamX - 1
        ...
        %  i - 1 elementos de x con la rotacion de los últimos tamX - i
        %  elementos de x, el resultado de esto al iterar tamX - 1, será
        %  la reflexión del vector
...
end %  Fin de la función invVector
