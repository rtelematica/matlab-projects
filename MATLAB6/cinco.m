...
title( 'Señal de voz con 10000 muestras' ),
ylabel( 'Amplitud' )
xlabel( 't' );
...
title( 'Gráfica de la señal de ruido con 200 muestras' ),
ylabel( 'Amplitud' )
xlabel( 'n' );
...
title( 'Autocorrelacion de la señal de ruido' ),
ylabel( 'Amplitud' )
xlabel( 'n' );
...
% Autocorrelacion de la señal de voz contaminada
...
title( 'Señal de voz contaminada' ),
ylabel( 'Amplitud' )
xlabel( 'n' );

figure( 6 )
% Gráfica de la autocorrelacion de la señal de voz contaminada
plot( 0 : length( autocorr_senal_voz_ruido ) - 1, autocorr_senal_voz_ruido ), 
title( 'Autocorrelación de la señal de voz contaminada' ),
ylabel( 'Amplitud' )
xlabel( 'n' );
...
for i = 0 : 50 %length( senal_voz_ruido ) / 200 - 1;
    ...
    title( 'Trama de 200 muestrasde la señal de voz contaminada' ),
    ylabel( 'Amplitud' )
    xlabel( 'n' );
    ...
    title( 'Autocorrelación de la trama de la señal de voz contaminada ' ),
    ylabel( 'Amplitud' )
    xlabel( 'n' );
