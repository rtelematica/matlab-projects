...
%  Observamos que la gráfica obtenida por la figura 1 se asemeja a una
%senoide cuando el resultado esperado debería ser una función semejante a
%una samplin.

%  El siguiente código muestra el cálculo mediante fft para obtener la X(w)
...
%  Resolviendo la DFT de Npuntos se obtiene la expresión:
%               sen(pikL/N)
%       x[k] = ----------- e(-jpik(L-1)/N)
%               sen(pik/N)
...
%Graficando en un periódo de -2N a 2N:
for k = -2*N : 2N 
